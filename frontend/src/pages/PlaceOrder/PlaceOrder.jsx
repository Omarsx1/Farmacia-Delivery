        ...
        <form onSubmit={placeOrder} className='place-order'>
            <div className="place-order-left">
                ...
                <div className="multi-field">
                    ...
                    <input type="text" name='state' onChange={onChangeHandler} value={data.state} placeholder='Distrito' required />
                </div>
                <div className="multi-field">
                ...
                <input type="text" name='phone' onChange={onChangeHandler} value={data.phone} placeholder='Celular' required />
            </div>
            <div className="place-order-right">
                <div className="cart-total">
                    ...
                    <div>
                        ...
                        <hr />
                        <div className="cart-total-details"><p>Delivery Gratis</p><p>{currency}{getTotalCartAmount() === 0 ? 0 : deliveryCharge}</p></div>
                        <hr />
